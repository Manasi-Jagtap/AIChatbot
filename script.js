...
// * setup api
const API_KEY = "AIzaSyA2fostW7009EACAf6jdAwuBczAH63_7jw";
const API_URL = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=${API_KEY}`

const userData = {
    message: null,
    file: {
        data: null, mime_type: null
    }
}
...
const generateBotResponse = async (incomingMessageDiv) => {
    ...
    try {
        ...
        //* reset users file data ,removing indicator and scroll chat to bottom
...
const handleOutgoingMessage = (e) => {
    ...
    setTimeout(() => {
        const messageContent = ` <svg class="bot-avatar" xmlns="http://www.w3.org/2000/svg"
                        width="50"
                        height="50" viewBox="0 0 1024 1024">
                        <path
...
fileInput.addEventListener('change', () => {
    ...
    reader.onload = (e) => {
        ...
        userData.file = {
            data: base64String, mime_type: file.type
        }
